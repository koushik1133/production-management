        ...
        <div style={{ position: 'sticky', top: '2rem' }}>
          ...
          {userRole === 'manager' ? (
            <section className="registration-card" style={{ background: 'var(--bg-card)', padding: '1.5rem', borderRadius: '16px', border: '1px solid var(--border-default)', boxShadow: 'var(--shadow-lg)' }}>
              <form onSubmit={handleSubmit} onKeyDown={(e) => { if (e.key === 'Enter' && (e.target as HTMLElement).tagName !== 'TEXTAREA') e.preventDefault(); }} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>

        ...
        {isLoading ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            {filtered.map(q => {
              ...
              const isBlackColor = q.trailer_color && (
                q.trailer_color.trim().toLowerCase() === 'black' || 
                q.trailer_color.trim().toLowerCase() === '#000' || 
                q.trailer_color.trim().toLowerCase() === '#000000' ||
                q.trailer_color.trim().toLowerCase() === '#111' ||
                q.trailer_color.trim().toLowerCase() === '#111111' ||
                q.trailer_color.trim().toLowerCase() === '#1a1a1a' ||
                q.trailer_color.trim().toLowerCase() === '#222'
              );

              return (
                <div key={q.id} style={{ background: 'var(--bg-card)', borderRadius: '16px', border: '1.5px solid rgba(255, 255, 255, 0.18)', padding: '1.25rem 1.5rem', display: 'flex', alignItems: 'center', gap: '1.5rem', boxShadow: 'var(--shadow-sm)' }}>
                  {/* Square color swatch */}
                  {q.trailer_color && (
                    <div 
                      ...
                      style={{ 
                        ...
                        border: isBlackColor 
                          ...
                          : ((q.trailer_color.toLowerCase() === 'white' || q.trailer_color === '#fff' || q.trailer_color === '#ffffff') 
                            ? '2px solid #94a3b8' 

...
DECLARE
  ...
  user_list JSONB := '[
    ...
    {"email": "tech@lanetrailers.com", "name": "Tech-support", "role": "manager"},
...
-- ====================================================================
-- PATCH: 2026-09-01 — SUPABASE CHAT GROUPS / CHANNELS
-- ====================================================================
...
-- ====================================================================
-- PASSWORD RESET QUICK REFERENCE (WITHOUT DELETING USERS)
-- ====================================================================
-- To reset any manager or employee password without touching their records:
-- UPDATE auth.users
-- SET encrypted_password = crypt('YourNewPasswordHere', gen_salt('bf')),
--     updated_at = now()
-- WHERE email = 'logan@lanetrailers.com';

NOTIFY pgrst, 'reload schema';

-- ====================================================================
-- PATCH: 2026-09-01 — AUTH REPAIR & IDENTITIES SYNC (Resolves 500 query schema)
-- ====================================================================
...
-- ========================================================
-- Performance Indexes to prevent timeouts & pool exhaustion
-- ========================================================
